        ...
        <div class="ps-lg-7 pt-4">            
            ...
            <v-row v-if="generalSettings.wallet_system == 1">
                ...
                <v-col cols="12" sm="4">
                    ...
                    <v-btn class="border-dashed border-gray-300 h-100 py-6" elevation="0" block x-large @click.stop="rechargeDialogShow = true">
                        <span>
            ...
            <v-row>
                <v-col cols="12" md="4">
                    <v-sheet color="grey lighten-5 border border-gray-200 mb-4 red--text" rounded="rounded" elevation="0" height="130" class="d-flex justify-center flex-column pa-5">
                        <div class="fw-500 text-h4">{{ getCartCount }}</div>
                        <div class="fw-700 fs-12">{{ $t("products_in_your_cart") }}</div>
                    </v-sheet>
                    <v-sheet color="grey lighten-5 border border-gray-200 mb-4 blue--text" rounded="rounded" elevation="0" height="130" class="d-flex justify-center flex-column pa-5">
                        <div class="fw-500 text-h4">{{ getTotalWishlisted }}</div>
                        <div class="fw-700 fs-12">{{ $t("products_in_your_wishlist") }}</div>
                    </v-sheet>
                    <v-sheet color="grey lighten-5 border border-gray-200 mb-4 green--text" rounded="rounded" elevation="0" height="130" class="d-flex justify-center flex-column pa-5">
                ...
                <v-col cols="12" md="4">
                    <v-sheet color="border border-gray-200 mb-4" rounded="rounded" height="422" elevation="0" class="pa-2">
                    ...
                    <v-sheet color="border border-gray-200 mb-4" rounded="rounded" height="405" elevation="0" class="pa-2 my-wishlist">
                ...
                <v-col cols="12" md="4">
                    <v-sheet color="border border-gray-200 mb-4" rounded="rounded" elevation="0" height="275" class="pa-4">
                    ...
                    <v-sheet rounded="rounded" elevation="0" height="131" class="mb-4">
                        <v-btn class="border-dashed border-gray-300 primary--text fs-14 h-100" elevation="0" block x-large  @click.stop="addressDialogShow = true">
                    ...
                    <v-sheet color="border border-gray-200 mb-4" rounded="rounded" height="405" elevation="0" class="pa-2 recenty-viewed">
