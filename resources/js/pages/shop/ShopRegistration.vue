<template>
    <v-container class="py-6">
        <div class="rounded border border-primary bg-soft-primary py-7 px-16 d-md-flex justify-space-between align-center mb-5">
            <h3 class="text-h5 fw-700 mb-5 mb-md-0">{{ $t('already_a_seller') }}</h3>
            <a :href="$store.getters['app/appUrl']+'/login'" class="btn primary px-12 py-3 rounded white--text fs-16" target="_blank">{{ $t('login') }}</a>
        </div>
        <banner :loading="false" :banner="$store.getters['app/banners'].shop_registration_page" class="mb-15"/>
        <v-row>
            <v-col cols="12" lg="6" md="8" sm="10" class="mx-auto">
                <h1 class="text-h3 fw-700 mb-8">{{ $t('register_your_shop') }}</h1>
                <v-form
                    lazy-validation
                ...
                >
                    <v-card class="border" elevation="0">
                        <v-card-title>
                            <span class="text-h6 fw-600 opacity-80">{{ $t('personal_information') }}</span>
                        </v-card-title>
                        <v-card-text>
                            <div class="mb-4">
                        ...
                        <v-card-title>
                            <span class="text-h6 fw-600 opacity-80">{{ $t('shop_information') }}</span>
                        </v-card-title>
                        <v-card-text>
                            <div class="mb-4">
                                <div class="mb-1 fs-13 fw-500">
